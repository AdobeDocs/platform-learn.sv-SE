...
# 3.3.3 Förbered din Adobe Experience Platform Data Collection Client-egenskap och Web SDK-konfiguration för Offer Decisioning
...
Varje gång du läser in en **allmän sida** nu, till exempel startsidan för demowebbplatsen, kommer Offer Decisioning att utvärdera vilket erbjudande som gäller och returnera ett svar till webbplatsen med information om erbjudandet som ska visas. För att visa erbjudandet på webbplatsen krävs ytterligare konfiguration, vilket du gör i nästa steg.
...
Gå till **Regler** i din egenskap. Sök efter och öppna regeln **Visningserbjudande (Offer Decisioning)**.
...
Rader 17 tillämpar den bild som Offer Decisioning returnerar på webbplatsen. Klicka på **[!UICONTROL Save]**.
...
Denna ändring innebär att den här regeln i Adobe Experience Platform Data Collection nu lyssnar på svaret från Offer Decisioning, som ingår i Web SDK-svaret, och när svaret tas emot visas bilden av erbjudandet på hemsidan.
...
- 1 Avtalsimplementering med din datainsamlingsegenskap
...
Gå till [3.3.4 Kombinera Adobe Target och Offer Decisioning](./ex4.md){target="_blank"}
