...
I den här modulen får du en praktisk genomgång av Adobe Journey Optimizer Offer Decisioning-funktioner.
...
- Förstå grundläggande terminologi som används som en del av Offer Decisioning.
- Lär dig hur du konfigurerar Offer Decisioning programtjänst så att den påverkar kundresor i realtid.
...
[3.3.3 Förbered din Data Collection Client-egenskap och Web SDK-installation för Offer Decisioning](./ex3.md)
