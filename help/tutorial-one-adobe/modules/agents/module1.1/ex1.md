...
## 1.1.1 Ange kontext i Agent Orchestrator
...
## 1.1.2 Börja med allmänna köptrender för att förankra kontexten och zooma in på fiber
...
## 1.1.3 Korrelera order med innehållsinställningar
...
## 1.1.4 Identifiera befintliga fiberresor
...
## 1.1.5 Se om det finns en relevant historisk kampanj
...
## 1.1.6 Validera resans prestanda via bortfallsanalys
...
## 1.1.7 Hitta befintliga målgrupper som är anpassade till hög användning
...
## 1.1.8 Bestäm om dessa målgrupper redan används
...
## 1.1.9 Skapa ny resa för Fibre Max Launch
