...
## 2.1.6.1 Lägg till plugin-programmet i ditt svar
...
## 2.1.6.4 ACDL-tillägg i taggegenskapen
...
## 2.1.6.5 Skicka data till Adobe Experience Platform Edge Network
...
## 2.1.6.6 Visa kundprofil i Adobe Experience Platform
