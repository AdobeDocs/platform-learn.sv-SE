...
Du måste ha följande program installerade på datorn innan du startar den här självstudiekursen:

- Adobe Creative Cloud
- Photoshop 2025
- Postman

## 1. Installera Chrome-tillägget för dokumentationen för Experience League

### Om Chrome-tillägget

Dokumentationen har gjorts generisk så att den enkelt kan återanvändas av vem som helst, med valfri Adobe-instans.
...
| Namn | Nyckel |
|:-------------:| :---------------:|
| IMS-organisations-ID | `--aepImsOrgId--` |
