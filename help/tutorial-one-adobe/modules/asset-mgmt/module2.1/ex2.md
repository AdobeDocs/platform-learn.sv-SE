...
# 1.1.2 Skapa en dokumentbaserad webbplats
...
## 1.1.2.1 Konfigurera Google Drive
...
## 1.1.2.2 Konfigurera GitHub-repo
...
## 1.1.2.3 Uppdatera filen fstab.yaml
...
## 1.1.2.4 Installera AEM Sidekick-tillägg
...
## 1.1.2.5 Förhandsgranska och publicera din dokumentbaserade webbplats
...
## 1.1.2.6 Ändra och publicera ändringen
