...
# Processautomatisering med Workfront Fusion

Lär dig bearbeta automatisering med Workfront Fusion.

## Iterera över flera värden
...
## Aktivera ditt scenario med en webkrok
...
1. Ange **Metodtypen** till **POST** och klistra in webbkrokens URL i adressfältet.
...
Gå till [Sammanfattning och fördelar med automatisering av Firefly-tjänster](./summary.md){target="_blank"}
