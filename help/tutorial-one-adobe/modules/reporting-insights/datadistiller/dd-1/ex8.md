...
Öppna Postman på datorn. Som en del av modul 2.1 skapade du en Postman-miljö och importerade en Postman-samling. Följ instruktionerna i [övning 2.1.3](./../../../../modules/delivery-activation/rtcdp-b2c/rtcdpb2c-1/ex3.md) om du inte har gjort det än.

Som en del av den Postman-samling som du importerade visas en mapp **3. Frågetjänst**. Om du inte ser den här mappen kan du ladda ned [Postman-samlingen](./../../../../assets/postman/postman_profile.zip) på nytt och importera samlingen i Postman enligt anvisningarna i [Exercise 2.1.3](./../../../../modules/delivery-activation/rtcdp-b2c/rtcdpb2c-1/ex3.md).
...
När POST-begäran lyckades returneras följande svar:
