...
1. Ersätt `@AppStorage`-värdet `YOUR_ENVIRONMENT_ID_GOES_HERE` för `environmentFileId` med det fil-ID för utvecklingsmiljö som du hämtade från taggar i [Skapa installationsanvisningar för SDK](configure-tags.md#generate-sdk-install-instructions).
...
1. Aktiverar felsökningsloggning. Mer information och alternativ finns i [dokumentationen för Adobe Experience Platform Mobile SDK](https://developer.adobe.com/client-sdks/documentation/getting-started/enable-debug-logging/).
...
Nästa: **[Konfigurera försäkring](assurance.md)**
