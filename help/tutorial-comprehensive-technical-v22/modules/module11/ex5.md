...
# 11.5 Visualisering med Customer Journey Analytics
...
Låt oss använda projektet som du skapade i [11.4 Dataförberedelser i Analysis Workspace](./ex4.md)så gå till [https://analytics.adobe.com](https://analytics.adobe.com).

![demo](./images/prohome.png)

Öppna ditt projekt `--demoProfileLdap-- - Omnichannel Analysis`.

När ditt projekt är öppet och datavyn `--demoProfileLdap-- - Omnichannel Analysis` är du redo att börja skapa dina första visualiseringar.
