...
# 11.4 Förberedelse av data i Analysis Workspace
...
## 11.4.1 Analysis Workspace-gränssnitt i CJA
...
## 11.4.3 Beräknade Dimensioner: Filter (segmentering) och datumintervall
...
Nästa steg: [11.5 Visualisering med Customer Journey Analytics](./ex5.md)
