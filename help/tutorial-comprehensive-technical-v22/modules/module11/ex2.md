...
# 11.2 Ansluta Adobe Experience Platform-datauppsättningar i Customer Journey Analytics
...
Använd den här namnkonventionen: `--demoProfileLdap-- – Omnichannel Data Connection`.
...
## 11.2.2 Markera Adobe Experience Platform-datauppsättningar
...
## 11.2.3 Person-ID och Datainhämtning
...
Nästa steg: [11.3 Skapa en datavy](./ex3.md)
