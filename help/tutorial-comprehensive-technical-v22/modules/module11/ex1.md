...
## 11.1.1 Vad är Customer Journey Analytics?
...
## 11.1.3 Varför välja Customer Journey Analytics?
...
## 11.1.4 Förstå arbetsflödet i Customer Journey Analytics
...
## 11.1.5 Steg 0: Om Adobe Experience Platform scheman och datauppsättningar
...
Du kan hitta identifierarna genom att öppna ett schema och titta på objektet `--aepTenantId--.identification.core`. Ta en titt på schemat [Demonstrationssystem - händelseschema för webbplats (Global v1.1)](https://experience.adobe.com/platform/schema).
...
Nästa steg: [11.2 Ansluta Adobe Experience Platform-datauppsättningar i Customer Journey Analytics](./ex2.md)
