---
title: Frågetjänst - Frågor, frågor, frågor.. och bortvinningsanalys
description: Frågetjänst - Frågor, frågor, frågor.. och bortvinningsanalys
kt: 5342
...
# 4.3 Frågor, frågor, frågor.. och bortvinningsanalys
...
I den här övningen skriver du frågor för att analysera produktvyer, produkttrattar, urn osv.

Alla frågor som listas i det här kapitlet kommer att köras i **PSQL kommandoradsgränssnitt**. Du bör kopiera (CTRL-c) de programsatsblock som anges med **SQL** och klistra in dem (CTRL-v) i **PSQL kommandoradsgränssnitt**. The **Frågeresultat** -block visar den inklistrade SQL-satsen och det associerade frågeresultatet.

## 4.3.1 Skriv grundläggande frågor för dataanalys

### Tidsstämpel

Data som samlats in i Adobe Experience Platform är tidsstämplade. The **tidsstämpel** kan du analysera data över tid.
...
Kopiera programsatsen ovan och kör den i **PSQL kommandoradsgränssnitt**.
...
Adobe har lagt till en uppsättning **Adobe-definierade funktioner** till den vanliga SQL-syntaxen som gör att du bättre kan förstå dina upplevelsedata. I de följande frågorna får du lära dig mer om dessa ADF-funktioner. Du hittar mer information och hela listan [i dokumentationen](https://experienceleague.adobe.com/docs/experience-platform/query/sql/adobe-defined-functions.html).

### Vad gör folk på webbplatsen innan de kommer till sidan&quot;Avbryt tjänst&quot; som den tredje sidan i en session?

Med den här frågan hittar du de två första Adobe-definierade funktionerna **SESS_TIMEOUT** och **NÄSTA**

> The **SESS_TIMEOUT()** återger de besöksgrupperingar som hittats med Adobe Analytics. Den utför en liknande tidsbaserad gruppering, men anpassningsbara parametrar.
>
...
För att svara på den här typen av frågor använder vi **TIME_BETWEEN_NEXT_MATCH()** Adobe definierad funktion.
...
Förklara att vi förenar datauppsättningar, i det här fallet ansluter vi oss till `demo_system_event_dataset_for_website_global_v1_1` med `demo_system_event_dataset_for_call_center_global_v1_1`. Vi gör detta för att veta resultatet av samspelet mellan call center.
...
I Windows klickar du på sökikonen (1) i verktygsfältet för Windows och skriver **anteckningsblock** i fältet &quot;search&quot; (2) klickar du på (3) &quot;notepad&quot;-resultatet:
...
Kopiera följande programsats till anteckningsblock/hakparenteser:
...
Kopiera det ändrade utdraget från **anteckningsblock** till **PSQL kommandoradsfönster** och tryck på Enter. Följande resultat visas i kommandoradsfönstret för PSQL:
...
I nästa steg kommer du att behålla frågan (kallas även **skapa tabell som markerad** eller **KATTER**) som en ny datauppsättning som du ska använda i Microsoft Power BI.

Nästa steg: [4.4 Generera en datauppsättning från en fråga](./ex4.md)
