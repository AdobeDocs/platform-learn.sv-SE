---
title: Slutsats och nästa steg i SDK-självstudiekursen för webben
description: Så här gör du när du är klar med självstudiekursen om Web SDK
...
Grattis! Du har avslutat självstudiekursen&quot;Implementera Adobe Experience Cloud med Web SDK&quot;!
...
* Web SDK-implementeringen är ansluten till följande Experience Cloud-program:
   * Adobe Experience Platform
   * Adobe Analytics
   * Adobe Audience Manager
   * Adobe Target
   * Adobe Journey Optimizer
* Vidarebefordrade data från Platform Edge Network till en webblänk med händelsevidarebefordran.
...
* **Utlös en resa i Journey Optimizer**. De händelser du implementerade på Lumas webbplats kan användas för att utlösa resor. Läs mer i den här [videosjälvstudien](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/journeys/use-case-transactional-journey).
* **Anslut Customer Journey Analytics**. Om du har skapat [plattformsdatauppsättningen](setup-experience-platform.md) kan du ansluta datauppsättningen till Customer Journey Analytics. Läs mer i den här [videosjälvstudien](https://experienceleague.adobe.com/en/docs/customer-journey-analytics-learn/tutorials/connections/connecting-customer-journey-analytics-to-data-sources-in-platform)
...
* **Implementera SDK för plattformen Mobile**. Nu när du har bemästrat en SDK, lär du dig en annan! Adobe Experience Platform Mobile SDK används för att driva Experience Cloud och tredjepartstjänster på mobilappar. Det finns en liknande [praktisk självstudiekurs för Mobile SDK](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/overview). Fyll i båda och se profilerna sammanfogas mellan olika enheter!
