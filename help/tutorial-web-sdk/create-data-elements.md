...
>
> Om identitetskartan innehåller båda `Luma CRM Id` och ECID `Luma CRM Id` blir [!UICONTROL primär] identitet. Om identitetskartan endast innehåller ECID blir ECID [!UICONTROL primär] identitet.
