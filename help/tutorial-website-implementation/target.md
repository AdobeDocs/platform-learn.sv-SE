...
Adobe Target-tillägget stöder implementeringar på klientsidan med Target-biblioteket at.js JavaScript. För Web SDK-implementeringar av Adobe Target, se [Experience Platform Web SDK-självstudiekursen](https://experienceleague.adobe.com/en/docs/platform-learn/implement-web-sdk/applications-setup/setup-target).
...
1. Bekräfta att `Launch` visas under rubriken `Target` i avsnittet `Extensions`
...
1. Klicka på **[!UICONTROL Conditions > Add]**
   ...
   1. Ange `Path equals` för `thank-you.html`
