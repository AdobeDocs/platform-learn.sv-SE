...
+ AI-assistenten {#ai-assistant}
   ...
   + [Produktsupportagent](/help/platform/ai-assistant/product-support-agent.md)
   + [Säkerhet - översikt](/help/platform/ai-assistant/security-overview.md)
+ API:er {#api}
   + [Autentisera till Experience Platform API:er](/help/platform/api/platform-api-authentication.md)
   + [Generera en åtkomsttoken](/help/platform/api/generate-an-access-token.md)
   + [Använd API:er](/help/platform/api/use-apis-with-postman.md)
+ Målgrupper och segmentering {#audiences}
   + Audience Builder{#audience-builder}
      + [Introduktion](audiences/audience-builder/introduction-to-audience-portal-and-composition.md)
      + [Överför målgrupper](audiences/audience-builder/upload-audiences.md)
      ...
      + [Demo av direktuppspelningssegmentering](/help/platform/audiences/audience-builder/streaming-segmentation-demo.md)
      + [Utvärdera batchmålgrupper på begäran](/help/platform/audiences/audience-builder/evaluate-audiences-on-demand.md)
   + Federerad målgruppssammansättning {#federated}
      + [Översikt](audiences/fac/overview-of-federated-audience-composition.md)
      + [Konfigurera en federerad anslutning](audiences/fac/connect-and-configure-federated-audience-composition.md)
      + [Anslut till Oracle](audiences/fac/connect-to-oracle.md)
      + [Skapa en federerad publik](audiences/fac/create-a-federated-audience-composition.md)
      + [Prenumerera på aviseringar](audiences/fac/subscribe-to-alerts.md)
   + Segmentmatchning{#segment-match}
      + [Anslutningsinställningar för segmentmatchning](/help/platform/audiences/segment-match/segment-match-connection-setup.md)
      + [Datastyrning för segmentmatchning](/help/platform/audiences/segment-match/segment-match-data-governance.md)
      + [Konfigurationsflöde för segmentmatchning](/help/platform/audiences/segment-match/segment-match-configuration-flow.md)
...
+ Collaboration {#collaboration}
   ...
   + [Real-Time CDP Overview for Agency Practisters](collaboration/rtcdp-overview-for-agency-practitioners.md)
   + [Collaboration - Process och People](collaboration/rtcdp-collaboration-process-and-people.md)
   ...
   + [Skapa ett projekt](collaboration/create-a-project.md)
...
+ Identiteter {#identities}
   ...
   + Länkningsregler för identitetsdiagram {#graph-linking-rules}
      ...
      + [Identitetsinställningar](/help/platform/identities/identity-graph-linking-rules/identity-settings.md)
...
+ Frågor och data Distiller {#queries}
