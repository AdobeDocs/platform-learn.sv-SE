...
+ Introduktion till Real-Time CDP {#rtcdp}
   + [Kort översikt](rtcdp/understanding-the-real-time-customer-data-platform.md)
   + [Så här använder du Real-Time CDP](rtcdp/understanding-the-real-time-customer-data-platform-user-interface.md)
...
+ AI-assistenten {#ai-assistant}
   ...
   + [Agent Orchestrator](/help/platform/ai-assistant/agent-orchestrator-ui.md)
   ...
   + [Experimentationsagent](/help/platform/ai-assistant/experimentation-agent-overview.md)
...
+ Collaboration {#collaboration}
   ...
   + [Upptäck överlappande målgrupper](collaboration/discover-audience-overlaps-in-projects.md)
   + [Aktivera målgrupper för medarbetare](collaboration/activate-audiences-in-projects.md)
   + [Varumärke](collaboration/brand-to-brand-collaboration.md)
...
+ Övervakning {#monitoring}
   ...
   + [Hantering av strömningskapacitet](monitoring/streaming-management.md)
...
+ Frågor och data Distiller {#queries}
   ...
   + [Validera data](/help/platform/queries/explore-data.md)
   + [Härleda data](/help/platform/queries/prepare-data.md)
   ...
   + [Analysera och visualisera data i Tablet](/help/platform/queries/analyze-and-visualize.md)
